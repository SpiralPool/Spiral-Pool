...
| [UPGRADE_GUIDE.md](setup/UPGRADE_GUIDE.md) | Upgrading to v2.2.5 (Phi Hash Reactor): compatibility, all coin types, step-by-step |
...
*Spiral Pool -- Phi Hash Reactor 2.2.5*
