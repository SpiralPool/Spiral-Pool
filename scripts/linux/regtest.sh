...
setup_coin() {
    ...
    case "$coin" in
        ...
        dgb)
            ...
            GBT_RULES='["segwit"]'
            # Auto-install info
            DAEMON_VERSION="9.26.4"
            DOWNLOAD_URL="https://github.com/DigiByte-Core/digibyte/releases/download/v9.26.4/digibyte-9.26.4-${ARCH_SUFFIX}.tar.gz"
            TARBALL_DIR="digibyte-9.26.4"
            ;;
        dgb-scrypt)
